...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
         ...
         KC_TAB, KC_GRAVE, KC_EQUAL, KC_LGUI, KC_LSFT, KC_FN4, KC_ENT, \
         KC_SPC, KC_FN0, KC_MINS, KC_QUOT, KC_BSPC),
  ...
  KEYMAP(KC_1, KC_2, KC_3, KC_4, KC_5, \
         ...
         KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDN, KC_NO, \
           KC_NO, KC_NO, KC_NO, KC_DOT, KC_BSLS,    \
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [4] = ACTION_MODS_TAP_KEY(MOD_LCTL, KC_ESC)  // hold ctrl, tap esc
};
